...
[3~5단락 요약. 핵심 내용, 실용적 적용법, 현재 프로젝트와의 관련성 위주로.]
...
## 프로젝트 적용
[이 내용을 현재 스택(Next.js / Nextron / Python)에 어떻게 적용할 수 있는지]
```
...
```bash
# Next.js 공식 문서
/update-knowledge --add https://nextjs.org/docs/app/building-your-application/caching "Next.js 캐싱"

# Supabase 문서
/update-knowledge --add https://supabase.com/docs/guides/auth "Supabase Auth 가이드"

# 레거시 .NET (유지보수 중인 프로젝트 한정)
/update-knowledge --add https://learn.microsoft.com/en-us/ef/core/ "EF Core 문서"
```
