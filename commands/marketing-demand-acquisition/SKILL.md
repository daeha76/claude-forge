...
**Campaign Execution:**
- **campaigns.md** - Structured campaign development framework and planning
- **content.md** - Copywriting guidelines and content creation templates
- **social_media.md** - Platform-specific social media strategies
- **email.md** - Email marketing templates and best practices
- **analytics.md** - KPIs, measurement, and reporting setup
- **brand.md** - Brand voice and visual standards
